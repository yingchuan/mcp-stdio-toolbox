...
from mcp_stdio_toolbox.subprocess_runner import run_command, build_command_args, SubprocessResult
...
async def test_stderr_truncation():
    ...
    result = await run_command("python3", ["-c", "import sys; sys.stderr.write('e' * 100); sys.stderr.write('\\n')"], max_output_bytes=50)
