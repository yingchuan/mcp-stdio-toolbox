...
from .subprocess_runner import run_command, build_command_args
    ...
    def _create_handler(self, tool_config: ToolConfig):
        ...
        async def handler(arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
            ...
            try:
                ...
                if result.truncated:
                    content.append({"type": "text", "text": "[Output was truncated due to size limit]"})
